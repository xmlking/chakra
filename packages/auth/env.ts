...
type _CoercedEnvSchema_150b7513 = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_150b7513 = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'BETTER_AUTH_URL' | 'BETTER_AUTH_JWT_EXPIRATION_TIME' | 'GOOGLE_CLIENT_ID' | 'GITHUB_CLIENT_ID' | 'MICROSOFT_CLIENT_ID' | 'MICROSOFT_TENANT_ID' | 'TURNSTILE_ENABLED' | 'TURNSTILE_SITE_KEY' | 'APP_ENV' | 'APP_NAME' | 'DB_POOL_MIN' | 'DB_POOL_MAX' | 'DB_POOL_SSL' | 'BETTER_AUTH_ADMINS' | 'BETTER_AUTH_ADMIN_EMAIL' | 'SHARED_ORGANIZATION_ID' | 'EMAIL_FROM' | 'EMAIL_TO' | 'RESEND_AUDIENCE_ID' | 'RESEND_TEMPLATE_ID' | 'CONFIRM_REDIRECT_URL' | 'SMTP_HOST' | 'SMTP_PORT' | 'SMTP_SECURE' | 'SMTP_USER'>>;
