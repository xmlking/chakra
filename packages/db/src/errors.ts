...
export enum PgErrorCode {
  ...
  STRING_DATA_RIGHT_TRUNCATION_DATA_EXCEPTION = "22001",
...
const PostgresErrorHandlers: Record<string, (error: DatabaseError) => ErrorHandler> = {
 ...
 */
export function getDbErrorMessage(error: unknown): ErrorHandler {
