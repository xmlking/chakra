...
type _CoercedEnvSchema_6b207221 = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_6b207221 = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'EMAIL_FROM' | 'EMAIL_TO' | 'RESEND_AUDIENCE_ID' | 'RESEND_TEMPLATE_ID' | 'CONFIRM_REDIRECT_URL' | 'SMTP_HOST' | 'SMTP_PORT' | 'SMTP_SECURE' | 'SMTP_USER' | 'APP_ENV' | 'APP_NAME'>>;
