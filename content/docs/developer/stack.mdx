...
<Card
  ...
  title="Turborepo - Make Ship Happen"
...
<Cards>
  ...
  <Card href="https://nextjs.org" title="Next.js" description="nextjs.org" icon={<Nextdotjs />} />
</Cards>
...
<Cards className="grid-cols-2 sm:grid-cols-3">
  <Card href="https://tailwindcss.com" title="Tailwind CSS" description="tailwindcss.com" icon={<TailwindCss />} />

<Card
  href="https://base-ui.com/"
  title="Base UI"
  description="base-ui.com"
  icon={<BaseUi className="invert" />}
/>

<Card href="https://ui.shadcn.com" title="shadcn/ui" description="ui.shadcn.com" icon={<ShadcnUi />} />
</Cards>
...
<Card href="https://www.postgresql.org" title="PostgreSQL" description="postgresql.org" icon={<Postgresql />} />
</Cards>
