...
<DocsCategory url="/docs/developer/documentation" />
...
You can configure & use the [built-in components](/docs/developer) in your MDX document, such as Tabs, Accordions and Zoomable Image.
