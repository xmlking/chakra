---
title: Vercel
description: "The architecture of a monorepo deployed to Vercel"
...
vercel teams switch astra
#
vercel env ls
vercel env ls --environment production
vercel env ls --scope astra
...
```shell
vercel link --repo --yes --scope astra --token $VERCEL_TOKEN
```
...
```shell
vercel logs astra-console.vercel.app
```
