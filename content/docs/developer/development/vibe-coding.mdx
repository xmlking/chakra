...
bunx skills@latest add dmmulroy/better-result@adopt-better-result
bunx skills@latest add dmmulroy/better-result@migrate-better-result-3
# vite-env skills
...
bunx skills add opencoredev/email-sdk --skill email-sdk-migrate
# React Doctor
bunx skills add https://github.com/aidenybai/react-doctor --skill improve-react

# Workflow SDK
bunx skills add https://github.com/vercel/workflow --skill workflow

# varlock
bunx skills add dmno-dev/varlock
```
