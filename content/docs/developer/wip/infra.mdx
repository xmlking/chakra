...
[FastAPI + PostgreSQL Compose Example](https://github.com/MeireMayumi/FastAPI-com-PostgreSQL/blob/main/compose.yaml)

[Bank UI Postgres Kubernetes YAML](https://github.com/chingnokas/bank-ui/blob/main/k8s/database/postgres.yaml)

[Fastfood Spring Boot Data StatefulSet YAML](https://github.com/sidneyaquino/fiappostech-techchallenge-fastfood-springboot/blob/main/k8s/data/data-statefulset.yaml)

use: kustomize and terraform
