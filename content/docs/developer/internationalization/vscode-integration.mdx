---
url: /docs/web/internationalization/vscode-integration
title: VSCode integration
description: VSCode extensions for mdz editing.
---
...
<video className="my-8" loop controls muted src="https://next-intl.dev/i18n-ally-demo.mp4" />
